...
namespace Warehouse_ConstructionWarehouseAPI.Migrations
{
    ...
    [Migration("20240527020645_AddForeignKeyToOrderTable")]
    partial class AddForeignKeyToOrderTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Warehouse_ConstructionWarehouseAPI.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = 1,
                            DeliveryStatus = 1,
                            OrderDate = new DateTime(2024, 5, 27, 5, 6, 44, 956, DateTimeKind.Local).AddTicks(745),
                            Phone = "+78005553535",
                            ProductId = 1,
                            Quantity = 10,
                        ...
                        new
                        {
                            ...
                            CustomerId = 1,
                            DeliveryStatus = 1,
                            OrderDate = new DateTime(2024, 5, 27, 5, 6, 44, 956, DateTimeKind.Local).AddTicks(755),
                            Phone = "+78012615441",
                            ProductId = 2,
                            Quantity = 15,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
