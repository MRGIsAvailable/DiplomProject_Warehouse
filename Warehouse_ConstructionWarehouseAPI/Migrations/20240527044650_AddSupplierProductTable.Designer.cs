...
namespace Warehouse_ConstructionWarehouseAPI.Migrations
{
    ...
    [Migration("20240527044650_AddSupplierProductTable")]
    partial class AddSupplierProductTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Warehouse_ConstructionWarehouseAPI.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            CategoryName = "Доставлено"
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Не доставлено"
                        });
                });
            ...
            modelBuilder.Entity("Warehouse_ConstructionWarehouseAPI.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = 1,
                            DeliveryStatus = 1,
                            OrderDate = new DateTime(2024, 5, 27, 7, 46, 50, 429, DateTimeKind.Local).AddTicks(1201),
                            Phone = "+78005553535",
                            ProductId = 1,
                            Quantity = 10,
                        ...
                        new
                        {
                            ...
                            CustomerId = 1,
                            DeliveryStatus = 1,
                            OrderDate = new DateTime(2024, 5, 27, 7, 46, 50, 429, DateTimeKind.Local).AddTicks(1212),
                            Phone = "+78012615441",
                            ProductId = 2,
                            Quantity = 15,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
